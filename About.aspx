<%@ Page Title="About" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="HolyInnocents.About" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section class="contactus">
        <div class="map">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d371.2348794456619!2d-87.66528092332183!3d41.89545849985485!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x880e2d2d2715579f%3A0xc7478d2c60a45970!2sHoly+Innocents+Church!5e0!3m2!1sen!2sus!4v1435548302088" style="border: 0; width: 100%; height: 400px;"></iframe>
        </div>
        <div class="container">
            <div class="col-md-7 col-sm-12 col-form">
                <h2 class="title-style-2">About Holy Innocents<span class="title-under"></span></h2>
                <div id="pagination" style="font-size: large; padding-left: 5%; padding-bottom: 20px;">
                    <a href="javascript:void();" style="padding-right: 5px;" onclick="NextPage();" id="Previous">Previous Page</a>

                    <a href="javascript:void(0);" style="padidng-left: 5px;" onclick="NextPage();" id="Next">Next Page</a>
                </div>
                <div class="blog-post" id="AboutDiv" style="padding-left: 20px;">
                    ...
                    <br />
                    <p>To continue reading is a detailed written history of our Parish history from our Anniversary Commemorative Albums on the church's 80th and 100th anniversary books, <a href="History.aspx">click here</a>. As a word of caution, this detailed history is not short, but knowing the history behind such a great part of our community helps create an appreciation for all of those who came before us. The stories written below originated with the early members of our parish.</p>
                    <br />
                ...
                <div id="pageCount" style="padding-top: 10px; padding-left: 20px;"><p id="count">1</p></div>
            </div>
            <div class="col-md-4 col-md-offset-1 col-contact">
                <h2 class="title-style-2">Mass Schedule<span class="title-under"></span></h2>
    ...
    <script type="text/javascript">
        ...
        function NextPage() {
            ...
            var CountDiv = document.getElementById("pageCount");
            var page = 0;
            page = parseInt(CountDiv.innerHTML);
            page += 1;
            CountDiv.innerHTML = page;
        }//close PreviousPage

        function UpdatePageCount(x, y) {

            var page = get('pageCount');    //parseInt(document.getElementById("pageCount:"));
            var CountDiv = document.getElementById("pageCount");
            console.log(page);
            page++;
            CountDiv.innerHTML = page;
