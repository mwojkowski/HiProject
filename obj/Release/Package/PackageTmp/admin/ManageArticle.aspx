        ...
        <article class="module width_full">
			        ...
			        <header><h3>Manage Article</h3></header>
				        ...
				        <div class="module_content">
                            <fieldset>
                                <asp:DropDownList ID="ArticleList" runat="server" DataSourceID="HiProjectSQL" DataTextField="Title" AutoPostBack="true" OnSelectedIndexChanged="ArticleSelected" DataValueField="id">
                                    <asp:ListItem Value="-1">Please Select:</asp:ListItem>
                                </asp:DropDownList>
                                <asp:SqlDataSource ID="HiProjectSQL" runat="server" ConnectionString="<%$ ConnectionStrings:AzureConnString %>" SelectCommand="SELECT [Title], [id] FROM [Posts]"></asp:SqlDataSource>
                            </fieldset>
						        <fieldset>
			        ...
			        <footer>
				        ...
				        <div class="submit_link">
                            <asp:Button ID="Delete" runat="server" Text="Delete" OnClick="deleteButton"/>
